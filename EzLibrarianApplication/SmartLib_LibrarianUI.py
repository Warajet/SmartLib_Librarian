...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/button/IMG/library.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.buttonOverview_Books.setAutoFillBackground(False)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/button/IMG/all_users.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/button/IMG/issue_books.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/button/IMG/add_book.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/button/IMG/add_user.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonOverview_AddUser.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/button/IMG/return_book.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonOverview_ReturnBook.setIcon(icon5)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.eye.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tabOverview, icon6, "")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icon_tool/Modern UI Icons Light/appbar.add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonBooks_Add.setIcon(icon7)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icon_tool/Modern UI Icons Light/appbar.edit.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonBooks_Edit.setIcon(icon8)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icon_tool/Modern UI Icons Light/appbar.delete.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonBooks_Delete.setIcon(icon9)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.arrow.right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonBooks_Go.setIcon(icon10)
        ...
        self.buttonBooks_Refresh.setIcon(icon11)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon_book/Modern UI Icons Light/appbar.book.list.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tabBooks, icon12, "")
        ...
        self.buttonUsers_Add.setIcon(icon7)
        ...
        self.buttonUsers_Edit.setIcon(icon8)
        ...
        self.buttonUsers_Delete.setIcon(icon9)
        ...
        self.buttonUsers_Go.setIcon(icon10)
        ...
        self.buttonUsers_Refresh.setIcon(icon11)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.people.multiple.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tabUsers, icon13, "")
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.calendar.day.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonHistory_Filter.setIcon(icon14)
        ...
        self.buttonHistory_Go.setIcon(icon10)
        ...
        self.tableHistory.setEditTriggers(QtWidgets.QAbstractItemView.AnyKeyPressed|QtWidgets.QAbstractItemView.EditKeyPressed)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.timer.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tabHistory, icon15, "")
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.return.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.buttonIssue_ReturnBook.setIcon(icon16)
        ...
        self.buttonIssue_Remind.setIcon(icon15)
        ...
        self.buttonIssue_Go.setIcon(icon10)
        ...
        self.buttonIssue_Refresh.setIcon(icon11)
        ...
        self.tableIssue.setEditTriggers(QtWidgets.QAbstractItemView.AnyKeyPressed|QtWidgets.QAbstractItemView.EditKeyPressed)
        ...
        icon17 = QtGui.QIcon()
        icon17.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.information.circle.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.tabWidget.addTab(self.tabIssue, icon17, "")
        ...
        icon18 = QtGui.QIcon()
        icon18.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.tiles.nine.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMain_Menu.setIcon(icon18)
        ...
        icon19 = QtGui.QIcon()
        icon19.addPixmap(QtGui.QPixmap(":/icon_book/Modern UI Icons Light/appbar.book.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_Book.setIcon(icon19)
        self.actionAdd_Book.setObjectName("actionAdd_Book")
        self.actionAdd_User = QtWidgets.QAction(MainWindow)
        icon20 = QtGui.QIcon()
        icon20.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.user.add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_User.setIcon(icon20)
        ...
        icon21 = QtGui.QIcon()
        icon21.addPixmap(QtGui.QPixmap(":/icon_book/Modern UI Icons Light/appbar.book.open.information.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReturnBook.setIcon(icon21)
        self.actionReturnBook.setVisible(True)
        self.actionReturnBook.setObjectName("actionReturnBook")
        self.actionExit = QtWidgets.QAction(MainWindow)
        icon22 = QtGui.QIcon()
        icon22.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.power.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon23 = QtGui.QIcon()
        icon23.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.graph.line.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReport.setIcon(icon23)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "SmartLibrary - Librarian Console"))
        ...
        self.actionReport.setText(_translate("MainWindow", "View Report"))
        self.actionReport.setStatusTip(_translate("MainWindow", "View statistical report"))
