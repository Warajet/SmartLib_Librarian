...
# Form implementation generated from reading ui file 'ezlib.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_4 = QtWidgets.QPushButton(self.tabOverview)
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.pushButton_5 = QtWidgets.QPushButton(self.tabOverview)
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.pushButton_6 = QtWidgets.QPushButton(self.tabOverview)
        font = QtGui.QFont()
        font.setPointSize(16)
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.tabIssue)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.horizontalLayout_7 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_7.setObjectName("horizontalLayout_7")
        self.toolButton_9 = QtWidgets.QToolButton(self.tabIssue)
        ...
        self.toolButton_10 = QtWidgets.QToolButton(self.tabIssue)
        ...
        self.toolButton_11 = QtWidgets.QToolButton(self.tabIssue)
        ...
        self.lineEdit_3 = QtWidgets.QLineEdit(self.tabIssue)
        self.lineEdit_3.setObjectName("lineEdit_3")
        self.horizontalLayout_7.addWidget(self.lineEdit_3)
        self.toolButton_12 = QtWidgets.QToolButton(self.tabIssue)
        ...
        self.verticalLayout_5.addWidget(self.tableIssue)
        icon11 = QtGui.QIcon()
        ...
        self.tabWidget.addTab(self.tabIssue, icon11, "")
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.tiles.nine.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionMain_Menu.setIcon(icon12)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/icon_book/Modern UI Icons Light/appbar.book.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_Book.setIcon(icon13)
        self.actionAdd_Book.setObjectName("actionAdd_Book")
        self.actionAdd_User = QtWidgets.QAction(MainWindow)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.user.add.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAdd_User.setIcon(icon14)
        ...
        icon15 = QtGui.QIcon()
        icon15.addPixmap(QtGui.QPixmap(":/icon_book/Modern UI Icons Light/appbar.book.open.information.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReturnBook.setIcon(icon15)
        ...
        icon16 = QtGui.QIcon()
        icon16.addPixmap(QtGui.QPixmap(":/icon_app/Modern UI Icons Light/appbar.paper.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionReport.setIcon(icon16)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "EasyLibrary Librarian v2"))
        self.labelOverview_Image.setText(_translate("MainWindow", "<html><head/><body><p><img src=\":/avatar/IMG/Susan_big.png\"/></p></body></html>"))
        self.labelOverview_Welcome.setText(_translate("MainWindow", "  Welcome    Mrs. Susan | 190389344"))
        ...
        self.pushButton_4.setText(_translate("MainWindow", "  Add Book"))
        self.pushButton_5.setText(_translate("MainWindow", "  Add User"))
        self.pushButton_6.setText(_translate("MainWindow", "  Return Book"))
        ...
        self.toolButton_9.setText(_translate("MainWindow", "  Add  "))
        self.toolButton_10.setText(_translate("MainWindow", "  Edit  "))
        self.toolButton_11.setText(_translate("MainWindow", "  Delete  "))
        self.label_5.setText(_translate("MainWindow", "Search:"))
        self.toolButton_12.setText(_translate("MainWindow", "Go"))
